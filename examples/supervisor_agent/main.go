...
func createSupervisor() (*graph.Graph, error) {
...
func createMathAgent() (*graph.Graph, error) {
	model := openai.NewModel()
...
func createHistoryAgent() (*graph.Graph, error) {
	model := openai.NewModel()
...
func createCodeAgent() (*graph.Graph, error) {
	model := openai.NewModel()
