...
func main() {
	...
	fmt.Println("    \"github.com/hupe1980/agentmesh/pkg/graph\"")
	fmt.Println("    modelmw \"github.com/hupe1980/agentmesh/pkg/model/middleware\"")
	fmt.Println("    toolmw \"github.com/hupe1980/agentmesh/pkg/tool/middleware\"")
	fmt.Println(")")
	fmt.Println("")
	fmt.Println("agent.NewReAct(model,")
	fmt.Println("    agent.WithGraphMiddleware(")
	fmt.Println("        graph.LoggingMiddleware(slog.Default()),")
	fmt.Println("        graph.RecoveryMiddleware(nil),")
	fmt.Println("    ),")
