...
// Render applies the provided state to the instruction template.
// It exposes helper functions to simplify defaulting, casing, and joins.
func Render(text string, state map[string]any) (string, error) {
