...
// The scope parameter provides access to graph state for context-aware discovery.
func (t *toolset) ListTools(ctx context.Context, _ graph.ReadOnlyScope) ([]tool.Tool, error) {
