...
// Accepts any *graph.Graph (agents, compiled graphs, etc.).
func NewExecutor(runnable *graph.Graph) *Executor {
...
func NewStreamingExecutor(compiled *graph.Graph) *StreamingExecutor {
