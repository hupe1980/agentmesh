...
func AgentNode(ctx context.Context, agentCardURL string, skillID string, opts ...a2aclient.FactoryOption) func(context.Context, graph.StateWriter) (*graph.NodeResult, error) {
...
func StreamingAgentNode(ctx context.Context, agentCardURL string, skillID string, opts ...a2aclient.FactoryOption) func(context.Context, graph.StateWriter) (*graph.NodeResult, error) {
	card, cardErr := agentcard.DefaultResolver.Resolve(ctx, agentCardURL)
	var client *a2aclient.Client
	var clientErr error
